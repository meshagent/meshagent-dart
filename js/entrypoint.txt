...
var init_define_process = __esm({
  "<define:process>"() {
    define_process_default = { env: "production", NODE_ENV: "production" };
  }
});
...
// node_modules/@kayahr/text-encoding/lib/main/ByteBuffer.js
var require_ByteBuffer = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/ByteBuffer.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ByteBuffer = exports.END_OF_BUFFER = void 0;
    exports.END_OF_BUFFER = -1;
    var ByteBuffer = class {
       ...
       */
      read() {
        return this.bytes.pop() ?? exports.END_OF_BUFFER;
      }
      /**
...
// node_modules/@kayahr/text-encoding/lib/main/constants.js
var require_constants = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/constants.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.FINISHED = exports.DEFAULT_ENCODING = void 0;
    exports.DEFAULT_ENCODING = "utf-8";
    exports.FINISHED = -1;
  }
});

// node_modules/@kayahr/text-encoding/lib/main/util.js
var require_util = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/util.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.indexOf = exports.inRange = exports.convertCodeUnitToBytes = exports.isASCII = void 0;
...
// node_modules/@kayahr/text-encoding/lib/main/decoders/Big5Decoder.js
var require_Big5Decoder = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/decoders/Big5Decoder.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.Big5Decoder = void 0;
    var big5 = require_big5_cp();
    var AbstractDecoder_1 = require_AbstractDecoder();
    var ByteBuffer_1 = require_ByteBuffer();
    var constants_1 = require_constants();
    var util_1 = require_util();
    var Big5Decoder = class extends AbstractDecoder_1.AbstractDecoder {
      lead = 0;
      /** @inheritDoc */
      decode(buffer) {
        const byte = buffer.read();
        if (byte === ByteBuffer_1.END_OF_BUFFER && this.lead !== 0) {
          this.lead = 0;
          return this.fail();
        }
        if (byte === ByteBuffer_1.END_OF_BUFFER && this.lead === 0) {
          return constants_1.FINISHED;
        }
        if (this.lead !== 0) {
          const lead = this.lead;
          this.lead = 0;
          const offset = byte < 127 ? 64 : 98;
          let index = null;
          if ((0, util_1.inRange)(byte, 64, 126) || (0, util_1.inRange)(byte, 161, 254)) {
            index = (lead - 129) * 157 + (byte - offset);
          }
          switch (index) {
            case 1133:
              return [202, 772];
          ...
          if (codePoint == null && (0, util_1.isASCII)(byte)) {
            buffer.write(byte);
          }
          return codePoint ?? this.fail();
        }
        if ((0, util_1.isASCII)(byte)) {
          return byte;
        }
        if ((0, util_1.inRange)(byte, 129, 254)) {
          this.lead = byte;
          return null;
        }
        return this.fail();
...
// node_modules/@kayahr/text-encoding/lib/main/AbstractEncoder.js
var require_AbstractEncoder = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/AbstractEncoder.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.AbstractEncoder = void 0;
    var AbstractEncoder = class {
      /**
...
// node_modules/@kayahr/text-encoding/lib/main/encoders/Big5Encoder.js
var require_Big5Encoder = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encoders/Big5Encoder.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.Big5Encoder = void 0;
    var big5 = require_big5_cp();
    var AbstractEncoder_1 = require_AbstractEncoder();
    var ByteBuffer_1 = require_ByteBuffer();
    var constants_1 = require_constants();
    var util_1 = require_util();
    function getIndex(codePoint) {
      big5WithoutHKSCs = big5WithoutHKSCs ?? big5.map((codePoint2, index2) => index2 < (161 - 129) * 157 ? null : codePoint2);
      const index = big5WithoutHKSCs;
      if (codePoint === 9552 || codePoint === 9566 || codePoint === 9569 || codePoint === 9578 || codePoint === 21313 || codePoint === 21317) {
        return index.lastIndexOf(codePoint);
      }
      return (0, util_1.indexOf)(index, codePoint);
    }
    var big5WithoutHKSCs = null;
    var Big5Encoder = class extends AbstractEncoder_1.AbstractEncoder {
      /** @inheritDoc */
      encode(buffer) {
        const codePoint = buffer.read();
        if (codePoint === ByteBuffer_1.END_OF_BUFFER) {
          return constants_1.FINISHED;
        }
        if ((0, util_1.isASCII)(codePoint)) {
          return codePoint;
        }
        ...
        const lead = Math.floor(index / 157) + 129;
        if (lead < 161) {
          return this.fail(codePoint);
        }
...
// node_modules/@kayahr/text-encoding/lib/main/Encoding.js
var require_Encoding = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/Encoding.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.Encoding = exports.getEncoding = exports.registerEncoding = void 0;
    var encodings = /* @__PURE__ */ new Map();
    function registerEncoding(name, labels, decoder2, encoder2) {
      const encoding = new Encoding(name, labels, decoder2, encoder2);
      for (const label of encoding.getLabels()) {
        encodings.set(label, encoding);
      }
      return encoding;
    }
    exports.registerEncoding = registerEncoding;
    ...
    var Encoding = class {
       ...
       */
      constructor(name, labels, decoder2, encoder2) {
        this.name = name;
        this.labels = labels;
  ...
  "node_modules/@kayahr/text-encoding/lib/main/decoders/EUCJPDecoder.js"(exports) {
    ...
    var EUCJPDecoder = class extends AbstractDecoder_1.AbstractDecoder {
      ...
      decode(buffer) {
        ...
        if (this.lead === 142 && (0, util_1.inRange)(byte, 161, 223)) {
          this.lead = 0;
          return 65377 - 161 + byte;
        }
        if (this.lead === 143 && (0, util_1.inRange)(byte, 161, 254)) {
        ...
        if (this.lead !== 0) {
          ...
          this.lead = 0;
          let codePoint = null;
          if ((0, util_1.inRange)(lead, 161, 254) && (0, util_1.inRange)(byte, 161, 254)) {
            codePoint = (this.jis0212Flag ? jis0212 : jis0208)[(lead - 161) * 94 + (byte - 161)] ?? null;
          }
          this.jis0212Flag = false;
          if (!(0, util_1.inRange)(byte, 161, 254)) {
            buffer.write(byte);
          }
          return codePoint ?? this.fail();
        }
        ...
        if (byte === 142 || byte === 143 || (0, util_1.inRange)(byte, 161, 254)) {
          this.lead = byte;
          return null;
        }
        return this.fail();
...
// node_modules/@kayahr/text-encoding/lib/main/encoders/EUCJPEncoder.js
var require_EUCJPEncoder = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encoders/EUCJPEncoder.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.EUCJPEncoder = void 0;
    var jis0208 = require_jis0208_cp();
    var AbstractEncoder_1 = require_AbstractEncoder();
    var ByteBuffer_1 = require_ByteBuffer();
    var constants_1 = require_constants();
    var util_1 = require_util();
    var EUCJPEncoder = class extends AbstractEncoder_1.AbstractEncoder {
      /** @inheritDoc */
      encode(buffer) {
        ...
        if ((0, util_1.inRange)(codePoint, 65377, 65439)) {
          return [142, codePoint - 65377 + 161];
        }
        if (codePoint === 8722) {
          codePoint = 65293;
        }
        const index = (0, util_1.indexOf)(jis0208, codePoint);
        if (index == null) {
          return this.fail(codePoint);
        }
        const lead = Math.floor(index / 94) + 161;
        const trail = index % 94 + 161;
        return [lead, trail];
      }
    };
    ...
    var EUCKRDecoder = class extends AbstractDecoder_1.AbstractDecoder {
      ...
      decode(buffer) {
        ...
        if (this.lead !== 0) {
          ...
          let index = null;
          this.lead = 0;
          if ((0, util_1.inRange)(byte, 65, 254)) {
            index = (lead - 129) * 190 + (byte - 65);
          }
          const codePoint = index == null ? null : euckr[index] ?? null;
          if (index == null && (0, util_1.isASCII)(byte)) {
            buffer.write(byte);
          }
          return codePoint ?? this.fail();
        }
...
// node_modules/@kayahr/text-encoding/lib/main/encoders/EUCKREncoder.js
var require_EUCKREncoder = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encoders/EUCKREncoder.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.EUCKREncoder = void 0;
    var euckr = require_euc_kr_cp();
    var AbstractEncoder_1 = require_AbstractEncoder();
    var ByteBuffer_1 = require_ByteBuffer();
    var constants_1 = require_constants();
    var util_1 = require_util();
    var EUCKREncoder = class extends AbstractEncoder_1.AbstractEncoder {
      /** @inheritDoc */
      encode(buffer) {
        const codePoint = buffer.read();
        if (codePoint === ByteBuffer_1.END_OF_BUFFER) {
        ...
        const index = (0, util_1.indexOf)(euckr, codePoint);
        if (index == null) {
          return this.fail(codePoint);
        }
        const lead = Math.floor(index / 190) + 129;
        const trail = index % 190 + 65;
        return [lead, trail];
      }
    };
...
// node_modules/@kayahr/text-encoding/lib/main/encodings/euc-kr.js
var require_euc_kr = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encodings/euc-kr.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    var EUCKRDecoder_1 = require_EUCKRDecoder();
    var EUCKREncoder_1 = require_EUCKREncoder();
    var Encoding_1 = require_Encoding();
    (0, Encoding_1.registerEncoding)("euc-kr", [
      "cseuckr",
      "csksc56011987",
      "euc-kr",
      "iso-ir-149",
...
var require_GBDecoder = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/decoders/GBDecoder.js"(exports) {
    ...
    var GBDecoder = class extends AbstractDecoder_1.AbstractDecoder {
      first = 0;
      second = 0;
      third = 0;
      /** @inheritDoc */
      decode(buffer) {
        const byte = buffer.read();
        if (byte === ByteBuffer_1.END_OF_BUFFER && this.first === 0 && this.second === 0 && this.third === 0) {
          return constants_1.FINISHED;
        }
        if (byte === ByteBuffer_1.END_OF_BUFFER && (this.first !== 0 || this.second !== 0 || this.third !== 0)) {
          this.first = 0;
        ...
        if (this.third !== 0) {
          codePoint = null;
          if ((0, util_1.inRange)(byte, 48, 57)) {
            codePoint = getCodePoint((((this.first - 129) * 10 + this.second - 48) * 126 + this.third - 129) * 10 + byte - 48);
          }
        ...
        if (this.first !== 0) {
          ...
          let index = null;
          this.first = 0;
          const offset = byte < 127 ? 64 : 65;
          if ((0, util_1.inRange)(byte, 64, 126) || (0, util_1.inRange)(byte, 128, 254)) {
            index = (lead - 129) * 190 + (byte - offset);
          }
    ...
    exports.GBDecoder = GBDecoder;
  }
});

// node_modules/@kayahr/text-encoding/lib/main/encoders/GBEncoder.js
var require_GBEncoder = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encoders/GBEncoder.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.GBKEncoder = exports.GB18030Encoder = exports.GBEncoder = exports.getIndex = void 0;
    var gb18030 = require_gb18030_cp();
    var gb18030ranges = require_gb18030_ranges();
    var AbstractEncoder_1 = require_AbstractEncoder();
    var ByteBuffer_1 = require_ByteBuffer();
    ...
    var GBEncoder = class extends AbstractEncoder_1.AbstractEncoder {
      gbkFlag;
      /**
       * @param gbkFlag - True for gbk encoding, false for gb18030 encoding.
       */
      constructor(gbkFlag = false) {
        super();
      ...
      encode(buffer) {
        ...
        if (this.gbkFlag && codePoint === 8364) {
          return 128;
        }
        let index = (0, util_1.indexOf)(gb18030, codePoint);
        if (index !== null) {
          const lead = Math.floor(index / 190) + 129;
    ...
    exports.GBEncoder = GBEncoder;
    var GB18030Encoder = class extends GBEncoder {
      /** @inheritDoc */
      constructor() {
        super(false);
      }
    ...
    var GBKEncoder = class extends GBEncoder {
      /** @inheritDoc */
      constructor() {
        super(true);
      }
    };
    exports.GBKEncoder = GBKEncoder;
  }
});

// node_modules/@kayahr/text-encoding/lib/main/encodings/gb18030.js
var require_gb18030 = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encodings/gb18030.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    var GBDecoder_1 = require_GBDecoder();
    var GBEncoder_1 = require_GBEncoder();
    var Encoding_1 = require_Encoding();
    (0, Encoding_1.registerEncoding)("gb18030", [
      "gb18030"
    ], GBDecoder_1.GBDecoder, GBEncoder_1.GB18030Encoder);
  }
});

// node_modules/@kayahr/text-encoding/lib/main/encodings/gbk.js
var require_gbk = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encodings/gbk.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    var GBDecoder_1 = require_GBDecoder();
    var GBEncoder_1 = require_GBEncoder();
    var Encoding_1 = require_Encoding();
    (0, Encoding_1.registerEncoding)("gbk", [
      "chinese",
      "csgb2312",
      "csiso58gb231280",
      "gb2312",
      ...
      "iso-ir-58",
      "x-gbk"
    ], GBDecoder_1.GBDecoder, GBEncoder_1.GBKEncoder);
  }
});

// node_modules/@kayahr/text-encoding/data/ibm866.cp.json
var require_ibm866_cp = __commonJS({
  "node_modules/@kayahr/text-encoding/data/ibm866.cp.json"(exports, module2) {
    module2.exports = [1040, 1041, 1042, 1043, 1044, 1045, 1046, 1047, 1048, 1049, 1050, 1051, 1052, 1053, 1054, 1055, 1056, 1057, 1058, 1059, 1060, 1061, 1062, 1063, 1064, 1065, 1066, 1067, 1068, 1069, 1070, 1071, 1072, 1073, 1074, 1075, 1076, 1077, 1078, 1079, 1080, 1081, 1082, 1083, 1084, 1085, 1086, 1087, 9617, 9618, 9619, 9474, 9508, 9569, 9570, 9558, 9557, 9571, 9553, 9559, 9565, 9564, 9563, 9488, 9492, 9524, 9516, 9500, 9472, 9532, 9566, 9567, 9562, 9556, 9577, 9574, 9568, 9552, 9580, 9575, 9576, 9572, 9573, 9561, 9560, 9554, 9555, 9579, 9578, 9496, 9484, 9608, 9604, 9612, 9616, 9600, 1088, 1089, 1090, 1091, 1092, 1093, 1094, 1095, 1096, 1097, 1098, 1099, 1100, 1101, 1102, 1103, 1025, 1105, 1028, 1108, 1031, 1111, 1038, 1118, 176, 8729, 183, 8730, 8470, 164, 9632, 160];
  }
});

// node_modules/@kayahr/text-encoding/lib/main/decoders/SingleByteDecoder.js
var require_SingleByteDecoder = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/decoders/SingleByteDecoder.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.SingleByteDecoder = void 0;
    var AbstractDecoder_1 = require_AbstractDecoder();
    var ByteBuffer_1 = require_ByteBuffer();
    var constants_1 = require_constants();
    var util_1 = require_util();
    var SingleByteDecoder = class extends AbstractDecoder_1.AbstractDecoder {
      index;
      /**
      ...
      decode(buffer) {
        const byte = buffer.read();
        if (byte === ByteBuffer_1.END_OF_BUFFER) {
          return constants_1.FINISHED;
        }
        if ((0, util_1.isASCII)(byte)) {
          return byte;
        }
        return this.index[byte - 128] ?? this.fail();
      }
    };
...
// node_modules/@kayahr/text-encoding/lib/main/encoders/SingleByteEncoder.js
var require_SingleByteEncoder = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encoders/SingleByteEncoder.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.SingleByteEncoder = void 0;
    var AbstractEncoder_1 = require_AbstractEncoder();
    var ByteBuffer_1 = require_ByteBuffer();
    var constants_1 = require_constants();
    var util_1 = require_util();
    var SingleByteEncoder = class extends AbstractEncoder_1.AbstractEncoder {
      index;
      /**
      ...
      encode(buffer) {
        ...
        const index = (0, util_1.indexOf)(this.index, codePoint);
        if (index == null) {
          return this.fail(codePoint);
        }
        return index + 128;
...
// node_modules/@kayahr/text-encoding/lib/main/encodings/ibm866.js
var require_ibm866 = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encodings/ibm866.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    var ibm866 = require_ibm866_cp();
    var SingleByteDecoder_1 = require_SingleByteDecoder();
    var SingleByteEncoder_1 = require_SingleByteEncoder();
    var Encoding_1 = require_Encoding();
    (0, Encoding_1.registerEncoding)("ibm866", [
      "866",
      "cp866",
      "csibm866",
      "ibm866"
    ], SingleByteDecoder_1.SingleByteDecoder.forCodePoints(ibm866), SingleByteEncoder_1.SingleByteEncoder.forCodePoints(ibm866));
  }
});

// node_modules/@kayahr/text-encoding/lib/main/decoders/ISO2022JPDecoder.js
var require_ISO2022JPDecoder = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/decoders/ISO2022JPDecoder.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ISO2022JPDecoder = void 0;
    var jis0208 = require_jis0208_cp();
    var AbstractDecoder_1 = require_AbstractDecoder();
    var ByteBuffer_1 = require_ByteBuffer();
    var constants_1 = require_constants();
    ...
    var State;
    (function(State2) {
      State2[State2["ASCII"] = 0] = "ASCII";
      State2[State2["Roman"] = 1] = "Roman";
      State2[State2["Katakana"] = 2] = "Katakana";
      State2[State2["LeadByte"] = 3] = "LeadByte";
      State2[State2["TrailByte"] = 4] = "TrailByte";
      State2[State2["EscapeStart"] = 5] = "EscapeStart";
      State2[State2["Escape"] = 6] = "Escape";
    })(State || (State = {}));
    var ISO2022JPDecoder = class extends AbstractDecoder_1.AbstractDecoder {
      state = State.ASCII;
      lead = 0;
      outputFlag = false;
      /** @inheritDoc */
      decode(buffer) {
        ...
        switch (this.state) {
          ...
          case State.ASCII:
            ...
            if ((0, util_1.inRange)(byte, 0, 127) && byte !== 14 && byte !== 15 && byte !== 27) {
          ...
          case State.Roman:
            ...
            if ((0, util_1.inRange)(byte, 0, 127) && byte !== 14 && byte !== 15 && byte !== 27 && byte !== 92 && byte !== 126) {
              this.outputFlag = false;
              return byte;
            }
            if (byte === ByteBuffer_1.END_OF_BUFFER) {
          ...
          case State.Katakana:
            ...
            if ((0, util_1.inRange)(byte, 33, 95)) {
              this.outputFlag = false;
              return 65377 - 33 + byte;
            }
            if (byte === ByteBuffer_1.END_OF_BUFFER) {
              return constants_1.FINISHED;
            }
          ...
          case State.LeadByte:
            ...
            if ((0, util_1.inRange)(byte, 33, 126)) {
              this.outputFlag = false;
              this.lead = byte;
          ...
          case State.TrailByte:
            ...
            if ((0, util_1.inRange)(byte, 33, 126)) {
              ...
              const index = (this.lead - 33) * 94 + byte - 33;
...
// node_modules/@kayahr/text-encoding/lib/main/encoders/ISO2022JPEncoder.js
var require_ISO2022JPEncoder = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encoders/ISO2022JPEncoder.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ISO2022JPEncoder = void 0;
    var jis0208 = require_jis0208_cp();
    var AbstractEncoder_1 = require_AbstractEncoder();
    var ByteBuffer_1 = require_ByteBuffer();
    var constants_1 = require_constants();
    ...
    (function(State2) {
      State2[State2["ASCII"] = 0] = "ASCII";
      State2[State2["Roman"] = 1] = "Roman";
      State2[State2["jis0208"] = 2] = "jis0208";
    })(State || (State = {}));
    var ISO2022JPEncoder = class extends AbstractEncoder_1.AbstractEncoder {
      state = State.ASCII;
      /** @inheritDoc */
      encode(buffer) {
        let codePoint = buffer.read();
        if (codePoint === ByteBuffer_1.END_OF_BUFFER && this.state !== State.ASCII) {
        ...
        if ((this.state === State.ASCII || this.state === State.Roman) && (codePoint === 14 || codePoint === 15 || codePoint === 27)) {
          return this.fail(65533);
        }
        if (this.state === State.ASCII && (0, util_1.isASCII)(codePoint)) {
          return codePoint;
        }
        if (this.state === State.Roman && ((0, util_1.isASCII)(codePoint) && codePoint !== 92 && codePoint !== 126 || (codePoint === 165 || codePoint === 8254))) {
          if ((0, util_1.isASCII)(codePoint)) {
            return codePoint;
          }
          if (codePoint === 165) {
        ...
        if ((0, util_1.isASCII)(codePoint) && this.state !== State.ASCII) {
          buffer.write(codePoint);
          this.state = State.ASCII;
          return [27, 40, 66];
        }
        if ((codePoint === 165 || codePoint === 8254) && this.state !== State.Roman) {
          buffer.write(codePoint);
        ...
        const lead = Math.floor(index / 94) + 33;
        const trail = index % 94 + 33;
        return [lead, trail];
      }
    };
...
// node_modules/@kayahr/text-encoding/lib/main/encodings/iso-2022-jp.js
var require_iso_2022_jp = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encodings/iso-2022-jp.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    var ISO2022JPDecoder_1 = require_ISO2022JPDecoder();
    var ISO2022JPEncoder_1 = require_ISO2022JPEncoder();
    var Encoding_1 = require_Encoding();
    (0, Encoding_1.registerEncoding)("iso-2022-jp", [
      "csiso2022jp",
      "iso-2022-jp"
    ], ISO2022JPDecoder_1.ISO2022JPDecoder, ISO2022JPEncoder_1.ISO2022JPEncoder);
  }
});

// node_modules/@kayahr/text-encoding/lib/main/decoders/ShiftJISDecoder.js
var require_ShiftJISDecoder = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/decoders/ShiftJISDecoder.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ShiftJISDecoder = void 0;
    var jis0208 = require_jis0208_cp();
    var AbstractDecoder_1 = require_AbstractDecoder();
    var ByteBuffer_1 = require_ByteBuffer();
    var constants_1 = require_constants();
    var util_1 = require_util();
    var ShiftJISDecoder = class extends AbstractDecoder_1.AbstractDecoder {
      lead = 0;
      /** @inheritDoc */
      decode(buffer) {
        const byte = buffer.read();
        ...
        if (this.lead !== 0) {
          ...
          this.lead = 0;
          const offset = byte < 127 ? 64 : 65;
          const leadOffset = lead < 160 ? 129 : 193;
          if ((0, util_1.inRange)(byte, 64, 126) || (0, util_1.inRange)(byte, 128, 252)) {
            index = (lead - leadOffset) * 188 + byte - offset;
          } else {
            return this.fail();
          }
          if ((0, util_1.inRange)(index, 8836, 10715)) {
            return 57344 - 8836 + index;
          }
        ...
        if ((0, util_1.isASCII)(byte) || byte === 128) {
          return byte;
        }
        if ((0, util_1.inRange)(byte, 161, 223)) {
          return 65377 - 161 + byte;
        }
        if ((0, util_1.inRange)(byte, 129, 159) || (0, util_1.inRange)(byte, 224, 252)) {
          this.lead = byte;
          return null;
        }
        return this.fail();
...
// node_modules/@kayahr/text-encoding/lib/main/encoders/ShiftJISEncoder.js
var require_ShiftJISEncoder = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encoders/ShiftJISEncoder.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ShiftJISEncoder = void 0;
    var jis0208 = require_jis0208_cp();
    var AbstractEncoder_1 = require_AbstractEncoder();
    var ByteBuffer_1 = require_ByteBuffer();
    var constants_1 = require_constants();
    var util_1 = require_util();
    function getIndex(codePoint) {
      shiftJIS = shiftJIS ?? jis0208.map((codePoint2, index) => (0, util_1.inRange)(index, 8272, 8835) ? null : codePoint2);
      return shiftJIS.indexOf(codePoint);
    }
    var shiftJIS = null;
    var ShiftJISEncoder = class extends AbstractEncoder_1.AbstractEncoder {
      /** @inheritDoc */
      encode(buffer) {
        let codePoint = buffer.read();
        if (codePoint === ByteBuffer_1.END_OF_BUFFER) {
        ...
        if ((0, util_1.isASCII)(codePoint) || codePoint === 128) {
          return codePoint;
        }
        if (codePoint === 165) {
          return 92;
        ...
        const leadOffset = lead < 31 ? 129 : 193;
...
// node_modules/@kayahr/text-encoding/lib/main/encodings/shift_jis.js
var require_shift_jis = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encodings/shift_jis.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    var ShiftJISDecoder_1 = require_ShiftJISDecoder();
    var ShiftJISEncoder_1 = require_ShiftJISEncoder();
    var Encoding_1 = require_Encoding();
    (0, Encoding_1.registerEncoding)("shift_jis", [
      "csshiftjis",
      "ms932",
      "ms_kanji",
      "shift-jis",
      ...
      "windows-31j",
      "x-sjis"
    ], ShiftJISDecoder_1.ShiftJISDecoder, ShiftJISEncoder_1.ShiftJISEncoder);
  }
});

// node_modules/@kayahr/text-encoding/lib/main/decoders/UTF8Decoder.js
var require_UTF8Decoder = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/decoders/UTF8Decoder.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var constants_1 = require_constants();
    var util_1 = require_util();
    var UTF8Decoder = class extends AbstractDecoder_1.AbstractDecoder {
      codePoint = 0;
      bytesSeen = 0;
      bytesNeeded = 0;
      lowerBoundary = 128;
      ...
      decode(buffer) {
        const byte = buffer.read();
        if (byte === ByteBuffer_1.END_OF_BUFFER && this.bytesNeeded !== 0) {
          this.bytesNeeded = 0;
          return this.fail();
        }
        if (byte === ByteBuffer_1.END_OF_BUFFER) {
        ...
        if (this.bytesNeeded === 0) {
          if ((0, util_1.inRange)(byte, 0, 127)) {
            return byte;
          } else if ((0, util_1.inRange)(byte, 194, 223)) {
            this.bytesNeeded = 1;
            this.codePoint = byte & 31;
          } else if ((0, util_1.inRange)(byte, 224, 239)) {
            if (byte === 224) {
          ...
          } else if ((0, util_1.inRange)(byte, 240, 244)) {
            if (byte === 240) {
        ...
        if (!(0, util_1.inRange)(byte, this.lowerBoundary, this.upperBoundary)) {
...
// node_modules/@kayahr/text-encoding/lib/main/encoders/UTF8Encoder.js
var require_UTF8Encoder = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encoders/UTF8Encoder.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var constants_1 = require_constants();
    var util_1 = require_util();
    var UTF8Encoder = class extends AbstractEncoder_1.AbstractEncoder {
      /** @inheritDoc */
      encode(buffer) {
        const codePoint = buffer.read();
        if (codePoint === ByteBuffer_1.END_OF_BUFFER) {
        ...
        let count;
        let offset;
        if ((0, util_1.inRange)(codePoint, 128, 2047)) {
          count = 1;
          offset = 192;
        } else if ((0, util_1.inRange)(codePoint, 2048, 65535)) {
          count = 2;
          offset = 224;
        } else if ((0, util_1.inRange)(codePoint, 65536, 1114111)) {
          count = 3;
          offset = 240;
        } else {
          return this.fail(codePoint);
...
// node_modules/@kayahr/text-encoding/lib/main/encodings/utf-8.js
var require_utf_8 = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encodings/utf-8.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    var UTF8Decoder_1 = require_UTF8Decoder();
    var UTF8Encoder_1 = require_UTF8Encoder();
    var Encoding_1 = require_Encoding();
    (0, Encoding_1.registerEncoding)("utf-8", [
      "unicode-1-1-utf-8",
      "utf-8",
      "utf8"
    ], UTF8Decoder_1.UTF8Decoder, UTF8Encoder_1.UTF8Encoder);
  }
});

// node_modules/@kayahr/text-encoding/lib/main/decoders/UTF16Decoder.js
var require_UTF16Decoder = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/decoders/UTF16Decoder.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.UTF16BEDecoder = exports.UTF16LEDecoder = exports.UTF16Decoder = void 0;
    var AbstractDecoder_1 = require_AbstractDecoder();
    var ByteBuffer_1 = require_ByteBuffer();
    var constants_1 = require_constants();
    var util_1 = require_util();
    var UTF16Decoder = class extends AbstractDecoder_1.AbstractDecoder {
      bigEndian;
      leadByte = null;
      leadSurrogate = null;
      /**
      ...
      decode(buffer) {
        const byte = buffer.read();
        if (byte === ByteBuffer_1.END_OF_BUFFER && (this.leadByte !== null || this.leadSurrogate !== null)) {
          return this.fail();
        }
        if (byte === ByteBuffer_1.END_OF_BUFFER && this.leadByte == null && this.leadSurrogate == null) {
          return constants_1.FINISHED;
        ...
        if (this.leadSurrogate !== null) {
          ...
          if ((0, util_1.inRange)(codeUnit, 56320, 57343)) {
            return 65536 + (leadSurrogate - 55296) * 1024 + (codeUnit - 56320);
          }
          buffer.write(...(0, util_1.convertCodeUnitToBytes)(codeUnit, this.bigEndian));
          return this.fail();
        }
        if ((0, util_1.inRange)(codeUnit, 55296, 56319)) {
    ...
    var UTF16LEDecoder = class extends UTF16Decoder {
      /** @inheritDoc */
      constructor(fatal) {
        super(false, fatal);
      }
    };
    exports.UTF16LEDecoder = UTF16LEDecoder;
    var UTF16BEDecoder = class extends UTF16Decoder {
      /** @inheritDoc */
      constructor(fatal) {
        super(true, fatal);
      }
    };
    exports.UTF16BEDecoder = UTF16BEDecoder;
  }
});

// node_modules/@kayahr/text-encoding/lib/main/encoders/UTF16Encoder.js
var require_UTF16Encoder = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encoders/UTF16Encoder.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.UTF16BEEncoder = exports.UTF16LEEncoder = exports.UTF16Encoder = void 0;
    var AbstractEncoder_1 = require_AbstractEncoder();
    var ByteBuffer_1 = require_ByteBuffer();
    var constants_1 = require_constants();
    var util_1 = require_util();
    var UTF16Encoder = class extends AbstractEncoder_1.AbstractEncoder {
      bigEndian;
      /**
       * @param bigEndian - True for utf-16be, false for utf-16le
       */
      ...
      encode(buffer) {
        ...
        if ((0, util_1.inRange)(codePoint, 0, 65535)) {
          return (0, util_1.convertCodeUnitToBytes)(codePoint, this.bigEndian);
        }
        const lead = (0, util_1.convertCodeUnitToBytes)((codePoint - 65536 >> 10) + 55296, this.bigEndian);
        const trail = (0, util_1.convertCodeUnitToBytes)((codePoint - 65536 & 1023) + 56320, this.bigEndian);
        return lead.concat(trail);
      }
    };
    exports.UTF16Encoder = UTF16Encoder;
    var UTF16LEEncoder = class extends UTF16Encoder {
      /** @inheritDoc */
      constructor() {
        super(false);
      }
    };
    exports.UTF16LEEncoder = UTF16LEEncoder;
    var UTF16BEEncoder = class extends UTF16Encoder {
      /** @inheritDoc */
      constructor() {
        super(true);
      }
    };
    exports.UTF16BEEncoder = UTF16BEEncoder;
  }
});

// node_modules/@kayahr/text-encoding/lib/main/encodings/utf-16le.js
var require_utf_16le = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encodings/utf-16le.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    var UTF16Decoder_1 = require_UTF16Decoder();
    var UTF16Encoder_1 = require_UTF16Encoder();
    var Encoding_1 = require_Encoding();
    (0, Encoding_1.registerEncoding)("utf-16le", [
      "utf-16",
      "utf-16le"
    ], UTF16Decoder_1.UTF16LEDecoder, UTF16Encoder_1.UTF16LEEncoder);
  }
});

// node_modules/@kayahr/text-encoding/lib/main/encodings/utf-16be.js
var require_utf_16be = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encodings/utf-16be.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    var UTF16Decoder_1 = require_UTF16Decoder();
    var UTF16Encoder_1 = require_UTF16Encoder();
    var Encoding_1 = require_Encoding();
    (0, Encoding_1.registerEncoding)("utf-16be", [
      "utf-16be"
    ], UTF16Decoder_1.UTF16BEDecoder, UTF16Encoder_1.UTF16BEEncoder);
  }
});

// node_modules/@kayahr/text-encoding/lib/main/encodings/utf-16.js
var require_utf_16 = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encodings/utf-16.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    require_utf_16be();
...
// node_modules/@kayahr/text-encoding/lib/main/decoders/XUserDefinedDecoder.js
var require_XUserDefinedDecoder = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/decoders/XUserDefinedDecoder.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.XUserDefinedDecoder = void 0;
    var AbstractDecoder_1 = require_AbstractDecoder();
    var ByteBuffer_1 = require_ByteBuffer();
    var constants_1 = require_constants();
    var util_1 = require_util();
    var XUserDefinedDecoder = class extends AbstractDecoder_1.AbstractDecoder {
      /** @inheritDoc */
      decode(buffer) {
        const byte = buffer.read();
        if (byte === ByteBuffer_1.END_OF_BUFFER) {
...
// node_modules/@kayahr/text-encoding/lib/main/encoders/XUserDefinedEncoder.js
var require_XUserDefinedEncoder = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encoders/XUserDefinedEncoder.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.XUserDefinedEncoder = void 0;
    var AbstractEncoder_1 = require_AbstractEncoder();
    var ByteBuffer_1 = require_ByteBuffer();
    var constants_1 = require_constants();
    var util_1 = require_util();
    var XUserDefinedEncoder = class extends AbstractEncoder_1.AbstractEncoder {
      /** @inheritDoc */
      encode(buffer) {
        const codePoint = buffer.read();
        if (codePoint === ByteBuffer_1.END_OF_BUFFER) {
        ...
        if ((0, util_1.inRange)(codePoint, 63360, 63487)) {
          return codePoint - 63360 + 128;
        }
        return this.fail(codePoint);
      }
    };
...
// node_modules/@kayahr/text-encoding/lib/main/encodings/x-user-defined.js
var require_x_user_defined = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encodings/x-user-defined.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    var XUserDefinedDecoder_1 = require_XUserDefinedDecoder();
    var XUserDefinedEncoder_1 = require_XUserDefinedEncoder();
    var Encoding_1 = require_Encoding();
    (0, Encoding_1.registerEncoding)("x-user-defined", [
      "x-user-defined"
    ], XUserDefinedDecoder_1.XUserDefinedDecoder, XUserDefinedEncoder_1.XUserDefinedEncoder);
  }
});

// node_modules/@kayahr/text-encoding/data/iso-8859-2.cp.json
var require_iso_8859_2_cp = __commonJS({
  "node_modules/@kayahr/text-encoding/data/iso-8859-2.cp.json"(exports, module2) {
    module2.exports = [128, 129, 130, 131, 132, 133, 134, 135, 136, 137, 138, 139, 140, 141, 142, 143, 144, 145, 146, 147, 148, 149, 150, 151, 152, 153, 154, 155, 156, 157, 158, 159, 160, 260, 728, 321, 164, 317, 346, 167, 168, 352, 350, 356, 377, 173, 381, 379, 176, 261, 731, 322, 180, 318, 347, 711, 184, 353, 351, 357, 378, 733, 382, 380, 340, 193, 194, 258, 196, 313, 262, 199, 268, 201, 280, 203, 282, 205, 206, 270, 272, 323, 327, 211, 212, 336, 214, 215, 344, 366, 218, 368, 220, 221, 354, 223, 341, 225, 226, 259, 228, 314, 263, 231, 269, 233, 281, 235, 283, 237, 238, 271, 273, 324, 328, 243, 244, 337, 246, 247, 345, 367, 250, 369, 252, 253, 355, 729];
  }
});

// node_modules/@kayahr/text-encoding/lib/main/encodings/iso-8859-2.js
var require_iso_8859_2 = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encodings/iso-8859-2.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    var iso88592 = require_iso_8859_2_cp();
    var SingleByteDecoder_1 = require_SingleByteDecoder();
    var SingleByteEncoder_1 = require_SingleByteEncoder();
    var Encoding_1 = require_Encoding();
    (0, Encoding_1.registerEncoding)("iso-8859-2", [
      "csisolatin2",
      "iso-8859-2",
      "iso-ir-101",
      "iso8859-2",
      ...
      "l2",
      "latin2"
    ], SingleByteDecoder_1.SingleByteDecoder.forCodePoints(iso88592), SingleByteEncoder_1.SingleByteEncoder.forCodePoints(iso88592));
  }
});

// node_modules/@kayahr/text-encoding/data/iso-8859-3.cp.json
var require_iso_8859_3_cp = __commonJS({
  "node_modules/@kayahr/text-encoding/data/iso-8859-3.cp.json"(exports, module2) {
...
// node_modules/@kayahr/text-encoding/lib/main/encodings/iso-8859-3.js
var require_iso_8859_3 = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encodings/iso-8859-3.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    var iso88593 = require_iso_8859_3_cp();
    var SingleByteDecoder_1 = require_SingleByteDecoder();
    var SingleByteEncoder_1 = require_SingleByteEncoder();
    var Encoding_1 = require_Encoding();
    (0, Encoding_1.registerEncoding)("iso-8859-3", [
      "csisolatin3",
      "iso-8859-3",
      "iso-ir-109",
      "iso8859-3",
      ...
      "l3",
      "latin3"
    ], SingleByteDecoder_1.SingleByteDecoder.forCodePoints(iso88593), SingleByteEncoder_1.SingleByteEncoder.forCodePoints(iso88593));
  }
});

// node_modules/@kayahr/text-encoding/data/iso-8859-4.cp.json
var require_iso_8859_4_cp = __commonJS({
  "node_modules/@kayahr/text-encoding/data/iso-8859-4.cp.json"(exports, module2) {
    module2.exports = [128, 129, 130, 131, 132, 133, 134, 135, 136, 137, 138, 139, 140, 141, 142, 143, 144, 145, 146, 147, 148, 149, 150, 151, 152, 153, 154, 155, 156, 157, 158, 159, 160, 260, 312, 342, 164, 296, 315, 167, 168, 352, 274, 290, 358, 173, 381, 175, 176, 261, 731, 343, 180, 297, 316, 711, 184, 353, 275, 291, 359, 330, 382, 331, 256, 193, 194, 195, 196, 197, 198, 302, 268, 201, 280, 203, 278, 205, 206, 298, 272, 325, 332, 310, 212, 213, 214, 215, 216, 370, 218, 219, 220, 360, 362, 223, 257, 225, 226, 227, 228, 229, 230, 303, 269, 233, 281, 235, 279, 237, 238, 299, 273, 326, 333, 311, 244, 245, 246, 247, 248, 371, 250, 251, 252, 361, 363, 729];
  }
});

// node_modules/@kayahr/text-encoding/lib/main/encodings/iso-8859-4.js
var require_iso_8859_4 = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encodings/iso-8859-4.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    var iso88594 = require_iso_8859_4_cp();
    var SingleByteDecoder_1 = require_SingleByteDecoder();
    var SingleByteEncoder_1 = require_SingleByteEncoder();
    var Encoding_1 = require_Encoding();
    (0, Encoding_1.registerEncoding)("iso-8859-4", [
      "csisolatin4",
      "iso-8859-4",
      "iso-ir-110",
      "iso8859-4",
      ...
      "l4",
      "latin4"
    ], SingleByteDecoder_1.SingleByteDecoder.forCodePoints(iso88594), SingleByteEncoder_1.SingleByteEncoder.forCodePoints(iso88594));
  }
});

// node_modules/@kayahr/text-encoding/data/iso-8859-5.cp.json
var require_iso_8859_5_cp = __commonJS({
  "node_modules/@kayahr/text-encoding/data/iso-8859-5.cp.json"(exports, module2) {
    module2.exports = [128, 129, 130, 131, 132, 133, 134, 135, 136, 137, 138, 139, 140, 141, 142, 143, 144, 145, 146, 147, 148, 149, 150, 151, 152, 153, 154, 155, 156, 157, 158, 159, 160, 1025, 1026, 1027, 1028, 1029, 1030, 1031, 1032, 1033, 1034, 1035, 1036, 173, 1038, 1039, 1040, 1041, 1042, 1043, 1044, 1045, 1046, 1047, 1048, 1049, 1050, 1051, 1052, 1053, 1054, 1055, 1056, 1057, 1058, 1059, 1060, 1061, 1062, 1063, 1064, 1065, 1066, 1067, 1068, 1069, 1070, 1071, 1072, 1073, 1074, 1075, 1076, 1077, 1078, 1079, 1080, 1081, 1082, 1083, 1084, 1085, 1086, 1087, 1088, 1089, 1090, 1091, 1092, 1093, 1094, 1095, 1096, 1097, 1098, 1099, 1100, 1101, 1102, 1103, 8470, 1105, 1106, 1107, 1108, 1109, 1110, 1111, 1112, 1113, 1114, 1115, 1116, 167, 1118, 1119];
  }
});

// node_modules/@kayahr/text-encoding/lib/main/encodings/iso-8859-5.js
var require_iso_8859_5 = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encodings/iso-8859-5.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    var iso88595 = require_iso_8859_5_cp();
    var SingleByteDecoder_1 = require_SingleByteDecoder();
    var SingleByteEncoder_1 = require_SingleByteEncoder();
    var Encoding_1 = require_Encoding();
    (0, Encoding_1.registerEncoding)("iso-8859-5", [
      "csisolatincyrillic",
      "cyrillic",
      "iso-8859-5",
      "iso-ir-144",
      ...
      "iso_8859-5",
      "iso_8859-5:1988"
    ], SingleByteDecoder_1.SingleByteDecoder.forCodePoints(iso88595), SingleByteEncoder_1.SingleByteEncoder.forCodePoints(iso88595));
  }
});

// node_modules/@kayahr/text-encoding/data/iso-8859-6.cp.json
var require_iso_8859_6_cp = __commonJS({
  "node_modules/@kayahr/text-encoding/data/iso-8859-6.cp.json"(exports, module2) {
...
// node_modules/@kayahr/text-encoding/lib/main/encodings/iso-8859-6.js
var require_iso_8859_6 = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encodings/iso-8859-6.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    var iso88596 = require_iso_8859_6_cp();
    var SingleByteDecoder_1 = require_SingleByteDecoder();
    var SingleByteEncoder_1 = require_SingleByteEncoder();
    var Encoding_1 = require_Encoding();
    (0, Encoding_1.registerEncoding)("iso-8859-6", [
      "arabic",
      "asmo-708",
      "csiso88596e",
      "csiso88596i",
      ...
      "iso_8859-6",
      "iso_8859-6:1987"
    ], SingleByteDecoder_1.SingleByteDecoder.forCodePoints(iso88596), SingleByteEncoder_1.SingleByteEncoder.forCodePoints(iso88596));
  }
});

// node_modules/@kayahr/text-encoding/data/iso-8859-7.cp.json
var require_iso_8859_7_cp = __commonJS({
  "node_modules/@kayahr/text-encoding/data/iso-8859-7.cp.json"(exports, module2) {
...
// node_modules/@kayahr/text-encoding/lib/main/encodings/iso-8859-7.js
var require_iso_8859_7 = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encodings/iso-8859-7.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    var iso88597 = require_iso_8859_7_cp();
    var SingleByteDecoder_1 = require_SingleByteDecoder();
    var SingleByteEncoder_1 = require_SingleByteEncoder();
    var Encoding_1 = require_Encoding();
    (0, Encoding_1.registerEncoding)("iso-8859-7", [
      "csisolatingreek",
      "ecma-118",
      "elot_928",
      "greek",
      ...
      "iso_8859-7:1987",
      "sun_eu_greek"
    ], SingleByteDecoder_1.SingleByteDecoder.forCodePoints(iso88597), SingleByteEncoder_1.SingleByteEncoder.forCodePoints(iso88597));
  }
});

// node_modules/@kayahr/text-encoding/data/iso-8859-8.cp.json
var require_iso_8859_8_cp = __commonJS({
  "node_modules/@kayahr/text-encoding/data/iso-8859-8.cp.json"(exports, module2) {
...
// node_modules/@kayahr/text-encoding/lib/main/encodings/iso-8859-8.js
var require_iso_8859_8 = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encodings/iso-8859-8.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    var iso88598 = require_iso_8859_8_cp();
    var SingleByteDecoder_1 = require_SingleByteDecoder();
    var SingleByteEncoder_1 = require_SingleByteEncoder();
    var Encoding_1 = require_Encoding();
    (0, Encoding_1.registerEncoding)("iso-8859-8", [
      "csiso88598e",
      "csisolatinhebrew",
      "hebrew",
      "iso-8859-8",
      ...
      "iso_8859-8:1988",
      "visual"
    ], SingleByteDecoder_1.SingleByteDecoder.forCodePoints(iso88598), SingleByteEncoder_1.SingleByteEncoder.forCodePoints(iso88598));
  }
});

// node_modules/@kayahr/text-encoding/data/iso-8859-10.cp.json
var require_iso_8859_10_cp = __commonJS({
  "node_modules/@kayahr/text-encoding/data/iso-8859-10.cp.json"(exports, module2) {
    module2.exports = [128, 129, 130, 131, 132, 133, 134, 135, 136, 137, 138, 139, 140, 141, 142, 143, 144, 145, 146, 147, 148, 149, 150, 151, 152, 153, 154, 155, 156, 157, 158, 159, 160, 260, 274, 290, 298, 296, 310, 167, 315, 272, 352, 358, 381, 173, 362, 330, 176, 261, 275, 291, 299, 297, 311, 183, 316, 273, 353, 359, 382, 8213, 363, 331, 256, 193, 194, 195, 196, 197, 198, 302, 268, 201, 280, 203, 278, 205, 206, 207, 208, 325, 332, 211, 212, 213, 214, 360, 216, 370, 218, 219, 220, 221, 222, 223, 257, 225, 226, 227, 228, 229, 230, 303, 269, 233, 281, 235, 279, 237, 238, 239, 240, 326, 333, 243, 244, 245, 246, 361, 248, 371, 250, 251, 252, 253, 254, 312];
  }
});

// node_modules/@kayahr/text-encoding/lib/main/encodings/iso-8859-10.js
var require_iso_8859_10 = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encodings/iso-8859-10.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    var iso885910 = require_iso_8859_10_cp();
    var SingleByteDecoder_1 = require_SingleByteDecoder();
    var SingleByteEncoder_1 = require_SingleByteEncoder();
    var Encoding_1 = require_Encoding();
    (0, Encoding_1.registerEncoding)("iso-8859-10", [
      "csisolatin6",
      "iso-8859-10",
      "iso-ir-157",
      "iso8859-10",
      ...
      "l6",
      "latin6"
    ], SingleByteDecoder_1.SingleByteDecoder.forCodePoints(iso885910), SingleByteEncoder_1.SingleByteEncoder.forCodePoints(iso885910));
  }
});

// node_modules/@kayahr/text-encoding/data/iso-8859-13.cp.json
var require_iso_8859_13_cp = __commonJS({
  "node_modules/@kayahr/text-encoding/data/iso-8859-13.cp.json"(exports, module2) {
    module2.exports = [128, 129, 130, 131, 132, 133, 134, 135, 136, 137, 138, 139, 140, 141, 142, 143, 144, 145, 146, 147, 148, 149, 150, 151, 152, 153, 154, 155, 156, 157, 158, 159, 160, 8221, 162, 163, 164, 8222, 166, 167, 216, 169, 342, 171, 172, 173, 174, 198, 176, 177, 178, 179, 8220, 181, 182, 183, 248, 185, 343, 187, 188, 189, 190, 230, 260, 302, 256, 262, 196, 197, 280, 274, 268, 201, 377, 278, 290, 310, 298, 315, 352, 323, 325, 211, 332, 213, 214, 215, 370, 321, 346, 362, 220, 379, 381, 223, 261, 303, 257, 263, 228, 229, 281, 275, 269, 233, 378, 279, 291, 311, 299, 316, 353, 324, 326, 243, 333, 245, 246, 247, 371, 322, 347, 363, 252, 380, 382, 8217];
  }
});

// node_modules/@kayahr/text-encoding/lib/main/encodings/iso-8859-13.js
var require_iso_8859_13 = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encodings/iso-8859-13.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    var iso885913 = require_iso_8859_13_cp();
    var SingleByteDecoder_1 = require_SingleByteDecoder();
    var SingleByteEncoder_1 = require_SingleByteEncoder();
    var Encoding_1 = require_Encoding();
    (0, Encoding_1.registerEncoding)("iso-8859-13", [
      "iso-8859-13",
      "iso8859-13",
      "iso885913"
    ], SingleByteDecoder_1.SingleByteDecoder.forCodePoints(iso885913), SingleByteEncoder_1.SingleByteEncoder.forCodePoints(iso885913));
  }
});

// node_modules/@kayahr/text-encoding/data/iso-8859-14.cp.json
var require_iso_8859_14_cp = __commonJS({
  "node_modules/@kayahr/text-encoding/data/iso-8859-14.cp.json"(exports, module2) {
    module2.exports = [128, 129, 130, 131, 132, 133, 134, 135, 136, 137, 138, 139, 140, 141, 142, 143, 144, 145, 146, 147, 148, 149, 150, 151, 152, 153, 154, 155, 156, 157, 158, 159, 160, 7682, 7683, 163, 266, 267, 7690, 167, 7808, 169, 7810, 7691, 7922, 173, 174, 376, 7710, 7711, 288, 289, 7744, 7745, 182, 7766, 7809, 7767, 7811, 7776, 7923, 7812, 7813, 7777, 192, 193, 194, 195, 196, 197, 198, 199, 200, 201, 202, 203, 204, 205, 206, 207, 372, 209, 210, 211, 212, 213, 214, 7786, 216, 217, 218, 219, 220, 221, 374, 223, 224, 225, 226, 227, 228, 229, 230, 231, 232, 233, 234, 235, 236, 237, 238, 239, 373, 241, 242, 243, 244, 245, 246, 7787, 248, 249, 250, 251, 252, 253, 375, 255];
  }
});

// node_modules/@kayahr/text-encoding/lib/main/encodings/iso-8859-14.js
var require_iso_8859_14 = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encodings/iso-8859-14.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    var iso885914 = require_iso_8859_14_cp();
    var SingleByteDecoder_1 = require_SingleByteDecoder();
    var SingleByteEncoder_1 = require_SingleByteEncoder();
    var Encoding_1 = require_Encoding();
    (0, Encoding_1.registerEncoding)("iso-8859-14", [
      "iso-8859-14",
      "iso8859-14",
      "iso885914"
    ], SingleByteDecoder_1.SingleByteDecoder.forCodePoints(iso885914), SingleByteEncoder_1.SingleByteEncoder.forCodePoints(iso885914));
  }
});

// node_modules/@kayahr/text-encoding/data/iso-8859-15.cp.json
var require_iso_8859_15_cp = __commonJS({
  "node_modules/@kayahr/text-encoding/data/iso-8859-15.cp.json"(exports, module2) {
    module2.exports = [128, 129, 130, 131, 132, 133, 134, 135, 136, 137, 138, 139, 140, 141, 142, 143, 144, 145, 146, 147, 148, 149, 150, 151, 152, 153, 154, 155, 156, 157, 158, 159, 160, 161, 162, 163, 8364, 165, 352, 167, 353, 169, 170, 171, 172, 173, 174, 175, 176, 177, 178, 179, 381, 181, 182, 183, 382, 185, 186, 187, 338, 339, 376, 191, 192, 193, 194, 195, 196, 197, 198, 199, 200, 201, 202, 203, 204, 205, 206, 207, 208, 209, 210, 211, 212, 213, 214, 215, 216, 217, 218, 219, 220, 221, 222, 223, 224, 225, 226, 227, 228, 229, 230, 231, 232, 233, 234, 235, 236, 237, 238, 239, 240, 241, 242, 243, 244, 245, 246, 247, 248, 249, 250, 251, 252, 253, 254, 255];
  }
});

// node_modules/@kayahr/text-encoding/lib/main/encodings/iso-8859-15.js
var require_iso_8859_15 = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encodings/iso-8859-15.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    var iso885915 = require_iso_8859_15_cp();
    var SingleByteDecoder_1 = require_SingleByteDecoder();
    var SingleByteEncoder_1 = require_SingleByteEncoder();
    var Encoding_1 = require_Encoding();
    (0, Encoding_1.registerEncoding)("iso-8859-15", [
      "csisolatin9",
      "iso-8859-15",
      "iso8859-15",
      "iso885915",
      "iso_8859-15",
      "l9"
    ], SingleByteDecoder_1.SingleByteDecoder.forCodePoints(iso885915), SingleByteEncoder_1.SingleByteEncoder.forCodePoints(iso885915));
  }
});

// node_modules/@kayahr/text-encoding/data/iso-8859-16.cp.json
var require_iso_8859_16_cp = __commonJS({
  "node_modules/@kayahr/text-encoding/data/iso-8859-16.cp.json"(exports, module2) {
    module2.exports = [128, 129, 130, 131, 132, 133, 134, 135, 136, 137, 138, 139, 140, 141, 142, 143, 144, 145, 146, 147, 148, 149, 150, 151, 152, 153, 154, 155, 156, 157, 158, 159, 160, 260, 261, 321, 8364, 8222, 352, 167, 353, 169, 536, 171, 377, 173, 378, 379, 176, 177, 268, 322, 381, 8221, 182, 183, 382, 269, 537, 187, 338, 339, 376, 380, 192, 193, 194, 258, 196, 262, 198, 199, 200, 201, 202, 203, 204, 205, 206, 207, 272, 323, 210, 211, 212, 336, 214, 346, 368, 217, 218, 219, 220, 280, 538, 223, 224, 225, 226, 259, 228, 263, 230, 231, 232, 233, 234, 235, 236, 237, 238, 239, 273, 324, 242, 243, 244, 337, 246, 347, 369, 249, 250, 251, 252, 281, 539, 255];
  }
});

// node_modules/@kayahr/text-encoding/lib/main/encodings/iso-8859-16.js
var require_iso_8859_16 = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encodings/iso-8859-16.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    var iso885916 = require_iso_8859_16_cp();
    var SingleByteDecoder_1 = require_SingleByteDecoder();
    var SingleByteEncoder_1 = require_SingleByteEncoder();
    var Encoding_1 = require_Encoding();
    (0, Encoding_1.registerEncoding)("iso-8859-16", [
      "iso-8859-16"
    ], SingleByteDecoder_1.SingleByteDecoder.forCodePoints(iso885916), SingleByteEncoder_1.SingleByteEncoder.forCodePoints(iso885916));
  }
});

// node_modules/@kayahr/text-encoding/data/koi8-r.cp.json
var require_koi8_r_cp = __commonJS({
  "node_modules/@kayahr/text-encoding/data/koi8-r.cp.json"(exports, module2) {
    module2.exports = [9472, 9474, 9484, 9488, 9492, 9496, 9500, 9508, 9516, 9524, 9532, 9600, 9604, 9608, 9612, 9616, 9617, 9618, 9619, 8992, 9632, 8729, 8730, 8776, 8804, 8805, 160, 8993, 176, 178, 183, 247, 9552, 9553, 9554, 1105, 9555, 9556, 9557, 9558, 9559, 9560, 9561, 9562, 9563, 9564, 9565, 9566, 9567, 9568, 9569, 1025, 9570, 9571, 9572, 9573, 9574, 9575, 9576, 9577, 9578, 9579, 9580, 169, 1102, 1072, 1073, 1094, 1076, 1077, 1092, 1075, 1093, 1080, 1081, 1082, 1083, 1084, 1085, 1086, 1087, 1103, 1088, 1089, 1090, 1091, 1078, 1074, 1100, 1099, 1079, 1096, 1101, 1097, 1095, 1098, 1070, 1040, 1041, 1062, 1044, 1045, 1060, 1043, 1061, 1048, 1049, 1050, 1051, 1052, 1053, 1054, 1055, 1071, 1056, 1057, 1058, 1059, 1046, 1042, 1068, 1067, 1047, 1064, 1069, 1065, 1063, 1066];
  }
});

// node_modules/@kayahr/text-encoding/lib/main/encodings/koi8-r.js
var require_koi8_r = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encodings/koi8-r.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    var koi8r = require_koi8_r_cp();
    var SingleByteDecoder_1 = require_SingleByteDecoder();
    var SingleByteEncoder_1 = require_SingleByteEncoder();
    var Encoding_1 = require_Encoding();
    (0, Encoding_1.registerEncoding)("koi8-r", [
      "cskoi8r",
      "koi",
      "koi8",
      "koi8-r",
      "koi8_r"
    ], SingleByteDecoder_1.SingleByteDecoder.forCodePoints(koi8r), SingleByteEncoder_1.SingleByteEncoder.forCodePoints(koi8r));
  }
});

// node_modules/@kayahr/text-encoding/data/koi8-u.cp.json
var require_koi8_u_cp = __commonJS({
  "node_modules/@kayahr/text-encoding/data/koi8-u.cp.json"(exports, module2) {
    module2.exports = [9472, 9474, 9484, 9488, 9492, 9496, 9500, 9508, 9516, 9524, 9532, 9600, 9604, 9608, 9612, 9616, 9617, 9618, 9619, 8992, 9632, 8729, 8730, 8776, 8804, 8805, 160, 8993, 176, 178, 183, 247, 9552, 9553, 9554, 1105, 1108, 9556, 1110, 1111, 9559, 9560, 9561, 9562, 9563, 1169, 1118, 9566, 9567, 9568, 9569, 1025, 1028, 9571, 1030, 1031, 9574, 9575, 9576, 9577, 9578, 1168, 1038, 169, 1102, 1072, 1073, 1094, 1076, 1077, 1092, 1075, 1093, 1080, 1081, 1082, 1083, 1084, 1085, 1086, 1087, 1103, 1088, 1089, 1090, 1091, 1078, 1074, 1100, 1099, 1079, 1096, 1101, 1097, 1095, 1098, 1070, 1040, 1041, 1062, 1044, 1045, 1060, 1043, 1061, 1048, 1049, 1050, 1051, 1052, 1053, 1054, 1055, 1071, 1056, 1057, 1058, 1059, 1046, 1042, 1068, 1067, 1047, 1064, 1069, 1065, 1063, 1066];
  }
});

// node_modules/@kayahr/text-encoding/lib/main/encodings/koi8-u.js
var require_koi8_u = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encodings/koi8-u.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    var koi8u = require_koi8_u_cp();
    var SingleByteDecoder_1 = require_SingleByteDecoder();
    var SingleByteEncoder_1 = require_SingleByteEncoder();
    var Encoding_1 = require_Encoding();
    (0, Encoding_1.registerEncoding)("koi8-u", [
      "koi8-ru",
      "koi8-u"
    ], SingleByteDecoder_1.SingleByteDecoder.forCodePoints(koi8u), SingleByteEncoder_1.SingleByteEncoder.forCodePoints(koi8u));
  }
});

// node_modules/@kayahr/text-encoding/data/macintosh.cp.json
var require_macintosh_cp = __commonJS({
  "node_modules/@kayahr/text-encoding/data/macintosh.cp.json"(exports, module2) {
    module2.exports = [196, 197, 199, 201, 209, 214, 220, 225, 224, 226, 228, 227, 229, 231, 233, 232, 234, 235, 237, 236, 238, 239, 241, 243, 242, 244, 246, 245, 250, 249, 251, 252, 8224, 176, 162, 163, 167, 8226, 182, 223, 174, 169, 8482, 180, 168, 8800, 198, 216, 8734, 177, 8804, 8805, 165, 181, 8706, 8721, 8719, 960, 8747, 170, 186, 937, 230, 248, 191, 161, 172, 8730, 402, 8776, 8710, 171, 187, 8230, 160, 192, 195, 213, 338, 339, 8211, 8212, 8220, 8221, 8216, 8217, 247, 9674, 255, 376, 8260, 8364, 8249, 8250, 64257, 64258, 8225, 183, 8218, 8222, 8240, 194, 202, 193, 203, 200, 205, 206, 207, 204, 211, 212, 63743, 210, 218, 219, 217, 305, 710, 732, 175, 728, 729, 730, 184, 733, 731, 711];
  }
});

// node_modules/@kayahr/text-encoding/lib/main/encodings/macintosh.js
var require_macintosh = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encodings/macintosh.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    var macintosh = require_macintosh_cp();
    var SingleByteDecoder_1 = require_SingleByteDecoder();
    var SingleByteEncoder_1 = require_SingleByteEncoder();
    var Encoding_1 = require_Encoding();
    (0, Encoding_1.registerEncoding)("macintosh", [
      "csmacintosh",
      "mac",
      "macintosh",
      "x-mac-roman"
    ], SingleByteDecoder_1.SingleByteDecoder.forCodePoints(macintosh), SingleByteEncoder_1.SingleByteEncoder.forCodePoints(macintosh));
  }
});

// node_modules/@kayahr/text-encoding/data/windows-874.cp.json
var require_windows_874_cp = __commonJS({
  "node_modules/@kayahr/text-encoding/data/windows-874.cp.json"(exports, module2) {
    module2.exports = [8364, 129, 130, 131, 132, 8230, 134, 135, 136, 137, 138, 139, 140, 141, 142, 143, 144, 8216, 8217, 8220, 8221, 8226, 8211, 8212, 152, 153, 154, 155, 156, 157, 158, 159, 160, 3585, 3586, 3587, 3588, 3589, 3590, 3591, 3592, 3593, 3594, 3595, 3596, 3597, 3598, 3599, 3600, 3601, 3602, 3603, 3604, 3605, 3606, 3607, 3608, 3609, 3610, 3611, 3612, 3613, 3614, 3615, 3616, 3617, 3618, 3619, 3620, 3621, 3622, 3623, 3624, 3625, 3626, 3627, 3628, 3629, 3630, 3631, 3632, 3633, 3634, 3635, 3636, 3637, 3638, 3639, 3640, 3641, 3642, 0, 0, 0, 0, 3647, 3648, 3649, 3650, 3651, 3652, 3653, 3654, 3655, 3656, 3657, 3658, 3659, 3660, 3661, 3662, 3663, 3664, 3665, 3666, 3667, 3668, 3669, 3670, 3671, 3672, 3673, 3674, 3675, 0, 0, 0, 0];
  }
});

// node_modules/@kayahr/text-encoding/lib/main/encodings/windows-874.js
var require_windows_874 = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encodings/windows-874.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    var windows874 = require_windows_874_cp();
    var SingleByteDecoder_1 = require_SingleByteDecoder();
    var SingleByteEncoder_1 = require_SingleByteEncoder();
    var Encoding_1 = require_Encoding();
    (0, Encoding_1.registerEncoding)("windows-874", [
      "dos-874",
      "iso-8859-11",
      "iso8859-11",
      "iso885911",
      "tis-620",
      "windows-874"
    ], SingleByteDecoder_1.SingleByteDecoder.forCodePoints(windows874), SingleByteEncoder_1.SingleByteEncoder.forCodePoints(windows874));
  }
});

// node_modules/@kayahr/text-encoding/data/windows-1250.cp.json
var require_windows_1250_cp = __commonJS({
  "node_modules/@kayahr/text-encoding/data/windows-1250.cp.json"(exports, module2) {
    module2.exports = [8364, 129, 8218, 131, 8222, 8230, 8224, 8225, 136, 8240, 352, 8249, 346, 356, 381, 377, 144, 8216, 8217, 8220, 8221, 8226, 8211, 8212, 152, 8482, 353, 8250, 347, 357, 382, 378, 160, 711, 728, 321, 164, 260, 166, 167, 168, 169, 350, 171, 172, 173, 174, 379, 176, 177, 731, 322, 180, 181, 182, 183, 184, 261, 351, 187, 317, 733, 318, 380, 340, 193, 194, 258, 196, 313, 262, 199, 268, 201, 280, 203, 282, 205, 206, 270, 272, 323, 327, 211, 212, 336, 214, 215, 344, 366, 218, 368, 220, 221, 354, 223, 341, 225, 226, 259, 228, 314, 263, 231, 269, 233, 281, 235, 283, 237, 238, 271, 273, 324, 328, 243, 244, 337, 246, 247, 345, 367, 250, 369, 252, 253, 355, 729];
  }
});

// node_modules/@kayahr/text-encoding/lib/main/encodings/windows-1250.js
var require_windows_1250 = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encodings/windows-1250.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    var windows1250 = require_windows_1250_cp();
    var SingleByteDecoder_1 = require_SingleByteDecoder();
    var SingleByteEncoder_1 = require_SingleByteEncoder();
    var Encoding_1 = require_Encoding();
    (0, Encoding_1.registerEncoding)("windows-1250", [
      "cp1250",
      "windows-1250",
      "x-cp1250"
    ], SingleByteDecoder_1.SingleByteDecoder.forCodePoints(windows1250), SingleByteEncoder_1.SingleByteEncoder.forCodePoints(windows1250));
  }
});

// node_modules/@kayahr/text-encoding/data/windows-1251.cp.json
var require_windows_1251_cp = __commonJS({
  "node_modules/@kayahr/text-encoding/data/windows-1251.cp.json"(exports, module2) {
    module2.exports = [1026, 1027, 8218, 1107, 8222, 8230, 8224, 8225, 8364, 8240, 1033, 8249, 1034, 1036, 1035, 1039, 1106, 8216, 8217, 8220, 8221, 8226, 8211, 8212, 152, 8482, 1113, 8250, 1114, 1116, 1115, 1119, 160, 1038, 1118, 1032, 164, 1168, 166, 167, 1025, 169, 1028, 171, 172, 173, 174, 1031, 176, 177, 1030, 1110, 1169, 181, 182, 183, 1105, 8470, 1108, 187, 1112, 1029, 1109, 1111, 1040, 1041, 1042, 1043, 1044, 1045, 1046, 1047, 1048, 1049, 1050, 1051, 1052, 1053, 1054, 1055, 1056, 1057, 1058, 1059, 1060, 1061, 1062, 1063, 1064, 1065, 1066, 1067, 1068, 1069, 1070, 1071, 1072, 1073, 1074, 1075, 1076, 1077, 1078, 1079, 1080, 1081, 1082, 1083, 1084, 1085, 1086, 1087, 1088, 1089, 1090, 1091, 1092, 1093, 1094, 1095, 1096, 1097, 1098, 1099, 1100, 1101, 1102, 1103];
  }
});

// node_modules/@kayahr/text-encoding/lib/main/encodings/windows-1251.js
var require_windows_1251 = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encodings/windows-1251.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    var windows1251 = require_windows_1251_cp();
    var SingleByteDecoder_1 = require_SingleByteDecoder();
    var SingleByteEncoder_1 = require_SingleByteEncoder();
    var Encoding_1 = require_Encoding();
    (0, Encoding_1.registerEncoding)("windows-1251", [
      "cp1251",
      "windows-1251",
      "x-cp1251"
    ], SingleByteDecoder_1.SingleByteDecoder.forCodePoints(windows1251), SingleByteEncoder_1.SingleByteEncoder.forCodePoints(windows1251));
  }
});

// node_modules/@kayahr/text-encoding/data/windows-1252.cp.json
var require_windows_1252_cp = __commonJS({
  "node_modules/@kayahr/text-encoding/data/windows-1252.cp.json"(exports, module2) {
    module2.exports = [8364, 129, 8218, 402, 8222, 8230, 8224, 8225, 710, 8240, 352, 8249, 338, 141, 381, 143, 144, 8216, 8217, 8220, 8221, 8226, 8211, 8212, 732, 8482, 353, 8250, 339, 157, 382, 376, 160, 161, 162, 163, 164, 165, 166, 167, 168, 169, 170, 171, 172, 173, 174, 175, 176, 177, 178, 179, 180, 181, 182, 183, 184, 185, 186, 187, 188, 189, 190, 191, 192, 193, 194, 195, 196, 197, 198, 199, 200, 201, 202, 203, 204, 205, 206, 207, 208, 209, 210, 211, 212, 213, 214, 215, 216, 217, 218, 219, 220, 221, 222, 223, 224, 225, 226, 227, 228, 229, 230, 231, 232, 233, 234, 235, 236, 237, 238, 239, 240, 241, 242, 243, 244, 245, 246, 247, 248, 249, 250, 251, 252, 253, 254, 255];
  }
});

// node_modules/@kayahr/text-encoding/lib/main/encodings/windows-1252.js
var require_windows_1252 = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encodings/windows-1252.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    var windows1252 = require_windows_1252_cp();
    var SingleByteDecoder_1 = require_SingleByteDecoder();
    var SingleByteEncoder_1 = require_SingleByteEncoder();
    var Encoding_1 = require_Encoding();
    (0, Encoding_1.registerEncoding)("windows-1252", [
      "ansi_x3.4-1968",
      "ascii",
      "cp1252",
      "cp819",
      ...
      "windows-1252",
      "x-cp1252"
    ], SingleByteDecoder_1.SingleByteDecoder.forCodePoints(windows1252), SingleByteEncoder_1.SingleByteEncoder.forCodePoints(windows1252));
  }
});

// node_modules/@kayahr/text-encoding/data/windows-1253.cp.json
var require_windows_1253_cp = __commonJS({
  "node_modules/@kayahr/text-encoding/data/windows-1253.cp.json"(exports, module2) {
    module2.exports = [8364, 129, 8218, 402, 8222, 8230, 8224, 8225, 136, 8240, 138, 8249, 140, 141, 142, 143, 144, 8216, 8217, 8220, 8221, 8226, 8211, 8212, 152, 8482, 154, 8250, 156, 157, 158, 159, 160, 901, 902, 163, 164, 165, 166, 167, 168, 169, 0, 171, 172, 173, 174, 8213, 176, 177, 178, 179, 900, 181, 182, 183, 904, 905, 906, 187, 908, 189, 910, 911, 912, 913, 914, 915, 916, 917, 918, 919, 920, 921, 922, 923, 924, 925, 926, 927, 928, 929, 0, 931, 932, 933, 934, 935, 936, 937, 938, 939, 940, 941, 942, 943, 944, 945, 946, 947, 948, 949, 950, 951, 952, 953, 954, 955, 956, 957, 958, 959, 960, 961, 962, 963, 964, 965, 966, 967, 968, 969, 970, 971, 972, 973, 974, 0];
  }
});

// node_modules/@kayahr/text-encoding/lib/main/encodings/windows-1253.js
var require_windows_1253 = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encodings/windows-1253.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    var windows1253 = require_windows_1253_cp();
    var SingleByteDecoder_1 = require_SingleByteDecoder();
    var SingleByteEncoder_1 = require_SingleByteEncoder();
    var Encoding_1 = require_Encoding();
    (0, Encoding_1.registerEncoding)("windows-1253", [
      "cp1253",
      "windows-1253",
      "x-cp1253"
    ], SingleByteDecoder_1.SingleByteDecoder.forCodePoints(windows1253), SingleByteEncoder_1.SingleByteEncoder.forCodePoints(windows1253));
  }
});

// node_modules/@kayahr/text-encoding/data/windows-1254.cp.json
var require_windows_1254_cp = __commonJS({
  "node_modules/@kayahr/text-encoding/data/windows-1254.cp.json"(exports, module2) {
    module2.exports = [8364, 129, 8218, 402, 8222, 8230, 8224, 8225, 710, 8240, 352, 8249, 338, 141, 142, 143, 144, 8216, 8217, 8220, 8221, 8226, 8211, 8212, 732, 8482, 353, 8250, 339, 157, 158, 376, 160, 161, 162, 163, 164, 165, 166, 167, 168, 169, 170, 171, 172, 173, 174, 175, 176, 177, 178, 179, 180, 181, 182, 183, 184, 185, 186, 187, 188, 189, 190, 191, 192, 193, 194, 195, 196, 197, 198, 199, 200, 201, 202, 203, 204, 205, 206, 207, 286, 209, 210, 211, 212, 213, 214, 215, 216, 217, 218, 219, 220, 304, 350, 223, 224, 225, 226, 227, 228, 229, 230, 231, 232, 233, 234, 235, 236, 237, 238, 239, 287, 241, 242, 243, 244, 245, 246, 247, 248, 249, 250, 251, 252, 305, 351, 255];
  }
});

// node_modules/@kayahr/text-encoding/lib/main/encodings/windows-1254.js
var require_windows_1254 = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encodings/windows-1254.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    var windows1254 = require_windows_1254_cp();
    var SingleByteDecoder_1 = require_SingleByteDecoder();
    var SingleByteEncoder_1 = require_SingleByteEncoder();
    var Encoding_1 = require_Encoding();
    (0, Encoding_1.registerEncoding)("windows-1254", [
      "cp1254",
      "csisolatin5",
      "iso-8859-9",
      "iso-ir-148",
      ...
      "windows-1254",
      "x-cp1254"
    ], SingleByteDecoder_1.SingleByteDecoder.forCodePoints(windows1254), SingleByteEncoder_1.SingleByteEncoder.forCodePoints(windows1254));
  }
});

// node_modules/@kayahr/text-encoding/data/windows-1255.cp.json
var require_windows_1255_cp = __commonJS({
  "node_modules/@kayahr/text-encoding/data/windows-1255.cp.json"(exports, module2) {
    module2.exports = [8364, 129, 8218, 402, 8222, 8230, 8224, 8225, 710, 8240, 138, 8249, 140, 141, 142, 143, 144, 8216, 8217, 8220, 8221, 8226, 8211, 8212, 732, 8482, 154, 8250, 156, 157, 158, 159, 160, 161, 162, 163, 8362, 165, 166, 167, 168, 169, 215, 171, 172, 173, 174, 175, 176, 177, 178, 179, 180, 181, 182, 183, 184, 185, 247, 187, 188, 189, 190, 191, 1456, 1457, 1458, 1459, 1460, 1461, 1462, 1463, 1464, 1465, 1466, 1467, 1468, 1469, 1470, 1471, 1472, 1473, 1474, 1475, 1520, 1521, 1522, 1523, 1524, 0, 0, 0, 0, 0, 0, 0, 1488, 1489, 1490, 1491, 1492, 1493, 1494, 1495, 1496, 1497, 1498, 1499, 1500, 1501, 1502, 1503, 1504, 1505, 1506, 1507, 1508, 1509, 1510, 1511, 1512, 1513, 1514, 0, 0, 8206, 8207, 0];
  }
});

// node_modules/@kayahr/text-encoding/lib/main/encodings/windows-1255.js
var require_windows_1255 = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encodings/windows-1255.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    var windows1255 = require_windows_1255_cp();
    var SingleByteDecoder_1 = require_SingleByteDecoder();
    var SingleByteEncoder_1 = require_SingleByteEncoder();
    var Encoding_1 = require_Encoding();
    (0, Encoding_1.registerEncoding)("windows-1255", [
      "cp1255",
      "windows-1255",
      "x-cp1255"
    ], SingleByteDecoder_1.SingleByteDecoder.forCodePoints(windows1255), SingleByteEncoder_1.SingleByteEncoder.forCodePoints(windows1255));
  }
});

// node_modules/@kayahr/text-encoding/data/windows-1256.cp.json
var require_windows_1256_cp = __commonJS({
  "node_modules/@kayahr/text-encoding/data/windows-1256.cp.json"(exports, module2) {
    module2.exports = [8364, 1662, 8218, 402, 8222, 8230, 8224, 8225, 710, 8240, 1657, 8249, 338, 1670, 1688, 1672, 1711, 8216, 8217, 8220, 8221, 8226, 8211, 8212, 1705, 8482, 1681, 8250, 339, 8204, 8205, 1722, 160, 1548, 162, 163, 164, 165, 166, 167, 168, 169, 1726, 171, 172, 173, 174, 175, 176, 177, 178, 179, 180, 181, 182, 183, 184, 185, 1563, 187, 188, 189, 190, 1567, 1729, 1569, 1570, 1571, 1572, 1573, 1574, 1575, 1576, 1577, 1578, 1579, 1580, 1581, 1582, 1583, 1584, 1585, 1586, 1587, 1588, 1589, 1590, 215, 1591, 1592, 1593, 1594, 1600, 1601, 1602, 1603, 224, 1604, 226, 1605, 1606, 1607, 1608, 231, 232, 233, 234, 235, 1609, 1610, 238, 239, 1611, 1612, 1613, 1614, 244, 1615, 1616, 247, 1617, 249, 1618, 251, 252, 8206, 8207, 1746];
  }
});

// node_modules/@kayahr/text-encoding/lib/main/encodings/windows-1256.js
var require_windows_1256 = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encodings/windows-1256.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    var windows1256 = require_windows_1256_cp();
    var SingleByteDecoder_1 = require_SingleByteDecoder();
    var SingleByteEncoder_1 = require_SingleByteEncoder();
    var Encoding_1 = require_Encoding();
    (0, Encoding_1.registerEncoding)("windows-1256", [
      "cp1256",
      "windows-1256",
      "x-cp1256"
    ], SingleByteDecoder_1.SingleByteDecoder.forCodePoints(windows1256), SingleByteEncoder_1.SingleByteEncoder.forCodePoints(windows1256));
  }
});

// node_modules/@kayahr/text-encoding/data/windows-1257.cp.json
var require_windows_1257_cp = __commonJS({
  "node_modules/@kayahr/text-encoding/data/windows-1257.cp.json"(exports, module2) {
    module2.exports = [8364, 129, 8218, 131, 8222, 8230, 8224, 8225, 136, 8240, 138, 8249, 140, 168, 711, 184, 144, 8216, 8217, 8220, 8221, 8226, 8211, 8212, 152, 8482, 154, 8250, 156, 175, 731, 159, 160, 0, 162, 163, 164, 0, 166, 167, 216, 169, 342, 171, 172, 173, 174, 198, 176, 177, 178, 179, 180, 181, 182, 183, 248, 185, 343, 187, 188, 189, 190, 230, 260, 302, 256, 262, 196, 197, 280, 274, 268, 201, 377, 278, 290, 310, 298, 315, 352, 323, 325, 211, 332, 213, 214, 215, 370, 321, 346, 362, 220, 379, 381, 223, 261, 303, 257, 263, 228, 229, 281, 275, 269, 233, 378, 279, 291, 311, 299, 316, 353, 324, 326, 243, 333, 245, 246, 247, 371, 322, 347, 363, 252, 380, 382, 729];
  }
});

// node_modules/@kayahr/text-encoding/lib/main/encodings/windows-1257.js
var require_windows_1257 = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encodings/windows-1257.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    var windows1257 = require_windows_1257_cp();
    var SingleByteDecoder_1 = require_SingleByteDecoder();
    var SingleByteEncoder_1 = require_SingleByteEncoder();
    var Encoding_1 = require_Encoding();
    (0, Encoding_1.registerEncoding)("windows-1257", [
      "cp1257",
      "windows-1257",
      "x-cp1257"
    ], SingleByteDecoder_1.SingleByteDecoder.forCodePoints(windows1257), SingleByteEncoder_1.SingleByteEncoder.forCodePoints(windows1257));
  }
});

// node_modules/@kayahr/text-encoding/data/windows-1258.cp.json
var require_windows_1258_cp = __commonJS({
  "node_modules/@kayahr/text-encoding/data/windows-1258.cp.json"(exports, module2) {
    module2.exports = [8364, 129, 8218, 402, 8222, 8230, 8224, 8225, 710, 8240, 138, 8249, 338, 141, 142, 143, 144, 8216, 8217, 8220, 8221, 8226, 8211, 8212, 732, 8482, 154, 8250, 339, 157, 158, 376, 160, 161, 162, 163, 164, 165, 166, 167, 168, 169, 170, 171, 172, 173, 174, 175, 176, 177, 178, 179, 180, 181, 182, 183, 184, 185, 186, 187, 188, 189, 190, 191, 192, 193, 194, 258, 196, 197, 198, 199, 200, 201, 202, 203, 768, 205, 206, 207, 272, 209, 777, 211, 212, 416, 214, 215, 216, 217, 218, 219, 220, 431, 771, 223, 224, 225, 226, 259, 228, 229, 230, 231, 232, 233, 234, 235, 769, 237, 238, 239, 273, 241, 803, 243, 244, 417, 246, 247, 248, 249, 250, 251, 252, 432, 8363, 255];
  }
});

// node_modules/@kayahr/text-encoding/lib/main/encodings/windows-1258.js
var require_windows_1258 = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encodings/windows-1258.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    var windows1258 = require_windows_1258_cp();
    var SingleByteDecoder_1 = require_SingleByteDecoder();
    var SingleByteEncoder_1 = require_SingleByteEncoder();
    var Encoding_1 = require_Encoding();
    (0, Encoding_1.registerEncoding)("windows-1258", [
      "cp1258",
      "windows-1258",
      "x-cp1258"
    ], SingleByteDecoder_1.SingleByteDecoder.forCodePoints(windows1258), SingleByteEncoder_1.SingleByteEncoder.forCodePoints(windows1258));
  }
});

// node_modules/@kayahr/text-encoding/data/x-mac-cyrillic.cp.json
var require_x_mac_cyrillic_cp = __commonJS({
  "node_modules/@kayahr/text-encoding/data/x-mac-cyrillic.cp.json"(exports, module2) {
    module2.exports = [1040, 1041, 1042, 1043, 1044, 1045, 1046, 1047, 1048, 1049, 1050, 1051, 1052, 1053, 1054, 1055, 1056, 1057, 1058, 1059, 1060, 1061, 1062, 1063, 1064, 1065, 1066, 1067, 1068, 1069, 1070, 1071, 8224, 176, 1168, 163, 167, 8226, 182, 1030, 174, 169, 8482, 1026, 1106, 8800, 1027, 1107, 8734, 177, 8804, 8805, 1110, 181, 1169, 1032, 1028, 1108, 1031, 1111, 1033, 1113, 1034, 1114, 1112, 1029, 172, 8730, 402, 8776, 8710, 171, 187, 8230, 160, 1035, 1115, 1036, 1116, 1109, 8211, 8212, 8220, 8221, 8216, 8217, 247, 8222, 1038, 1118, 1039, 1119, 8470, 1025, 1105, 1103, 1072, 1073, 1074, 1075, 1076, 1077, 1078, 1079, 1080, 1081, 1082, 1083, 1084, 1085, 1086, 1087, 1088, 1089, 1090, 1091, 1092, 1093, 1094, 1095, 1096, 1097, 1098, 1099, 1100, 1101, 1102, 8364];
  }
});

// node_modules/@kayahr/text-encoding/lib/main/encodings/x-mac-cyrillic.js
var require_x_mac_cyrillic = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encodings/x-mac-cyrillic.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    var xMacCyrillic = require_x_mac_cyrillic_cp();
    var SingleByteDecoder_1 = require_SingleByteDecoder();
    var SingleByteEncoder_1 = require_SingleByteEncoder();
    var Encoding_1 = require_Encoding();
    (0, Encoding_1.registerEncoding)("x-mac-cyrillic", [
      "x-mac-cyrillic",
      "x-mac-ukrainian"
    ], SingleByteDecoder_1.SingleByteDecoder.forCodePoints(xMacCyrillic), SingleByteEncoder_1.SingleByteEncoder.forCodePoints(xMacCyrillic));
  }
});

// node_modules/@kayahr/text-encoding/lib/main/encodings.js
var require_encodings = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/encodings.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    require_big5();
    ...
    require_macintosh();
    require_windows_874();
    require_windows_1250();
    require_windows_1251();
    require_windows_1252();
    require_windows_1253();
    require_windows_1254();
    require_windows_1255();
    require_windows_1256();
    require_windows_1257();
    require_windows_1258();
    require_x_mac_cyrillic();
  }
});

// node_modules/@kayahr/text-encoding/lib/main/TextDecoder.js
var require_TextDecoder = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/TextDecoder.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var TextDecoder3 = class {
       ...
       */
      constructor(label = constants_1.DEFAULT_ENCODING, { fatal = false, ignoreBOM = false } = {}) {
        this.enc = (0, Encoding_1.getEncoding)(label);
        this.fatal = fatal;
      ...
      decode(input, { stream = false } = {}) {
        ...
        const inputStream = new ByteBuffer_1.ByteBuffer(bytes);
        let output = "";
        let result;
        while (!inputStream.isEndOfBuffer()) {
          result = this.decoder.decode(inputStream);
          if (result === constants_1.FINISHED) {
            break;
          }
          if (result != null) {
...
// node_modules/@kayahr/text-encoding/lib/main/TextEncoder.js
var require_TextEncoder = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/TextEncoder.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.createTextEncoder = exports.TextEncoder = void 0;
    var ByteBuffer_1 = require_ByteBuffer();
    var constants_1 = require_constants();
    var Encoding_1 = require_Encoding();
    ...
    var TextEncoder3 = class {
      ...
      encode(input = "") {
        ...
        const inputStream = new ByteBuffer_1.ByteBuffer(stringToCodePoints(input));
        const output = [];
        let result;
        while (true) {
      ...
      encodeInto(source, destination) {
        ...
        const inputStream = new ByteBuffer_1.ByteBuffer(stringToCodePoints(source));
        let result;
        let read = 0;
        let written = 0;
...
// node_modules/@kayahr/text-encoding/lib/main/index.js
var require_main = __commonJS({
  "node_modules/@kayahr/text-encoding/lib/main/index.js"(exports) {
    "use strict";
    init_define_process();
    Object.defineProperty(exports, "__esModule", { value: true });
    var tslib_1 = (init_tslib_es6(), __toCommonJS(tslib_es6_exports));
    require_encodings();
    tslib_1.__exportStar(require_TextDecoder(), exports);
    tslib_1.__exportStar(require_TextEncoder(), exports);
  }
});
...
// node_modules/lib0/environment.js
var isNode = typeof define_process_default !== "undefined" && define_process_default.release && /node|io\.js/.test(define_process_default.release.name) && Object.prototype.toString.call(typeof define_process_default !== "undefined" ? define_process_default : 0) === "[object process]";
...
var computeParams = () => {
  if (params === void 0) {
    if (isNode) {
      params = create();
      const pargs = define_process_default.argv;
...
var getVariable = (name) => isNode ? undefinedToNull(define_process_default.env[name.toUpperCase().replaceAll("-", "_")]) : undefinedToNull(varStorage.getItem(name));
var hasConf = (name) => hasParam("--" + name) || getVariable(name) !== null;
var production = hasConf("production");
var forceColor = isNode && isOneOf(define_process_default.env.FORCE_COLOR, ["true", "1", "2"]);
var supportsColor = forceColor || !hasParam("--no-colors") && // @todo deprecate --no-colors
!hasConf("no-color") && (!isNode || define_process_default.stdout.isTTY) && (!isNode || hasParam("--color") || getVariable("COLORTERM") !== null || (getVariable("TERM") || "").includes("color"));
...
var glo = (
  /** @type {any} */
  typeof globalThis !== "undefined" ? globalThis : typeof window !== "undefined" ? window : typeof window !== "undefined" ? window : {}
);
...
// server.js
var uuid = v4_default;
var ServerXmlDocument = class {
  constructor(doc2, notifyChanges) {
    this._y = doc2.get("xml", YXmlElement);
    this.doc = doc2;
    this._y.observeDeep((yxmlEvents) => {
      for (let yxmlEvent of yxmlEvents) {
        const target = yxmlEvent.target;
        if (target instanceof YXmlElement) {
  ...
  doDelete(element2) {
    let i = 0;
    if (element2.parent) {
      for (let e = element2.parent.firstChild; e != null; e = e.nextSibling) {
        if (e == element2) {
          element2.parent.delete(i, 1);
          return;
        }
        i++;
      }
      throw new Error("element was not deleted" + element2);
    } else {
  ...
  createNodes(children) {
    ...
    for (let child of children) {
      if (child.text) {
        const text2 = new YXmlText();
        if (text2.delta) {
          text2.applyDelta(text2.delta);
        }
        nodes.push(text2);
      } else if (child.element) {
        const element2 = new YXmlElement(child.element.name);
        element2.setAttribute("$id", child.element.attributes?.id ?? uuid());
        if (child.element.attributes) {
          for (let k of Object.keys(child.element.attributes)) {
            element2.setAttribute(k, child.element.attributes[k]);
          }
        }
        if (child.element.children) {
          element2.insert(0, this.createNodes(child.element.children));
        }
        nodes.push(element2);
      } else {
  ...
  doInsertChildren(element2, { after, index, children }) {
    let afterElement;
    if (after) {
      for (let e = element2.firstChild; e != null; e = e.nextSibling) {
        if (e instanceof YXmlElement) {
    ...
    if (afterElement) {
      element2.insertAfter(afterElement, this.createNodes(children));
    } else {
      if (index !== void 0 && index != null) {
        element2.insert(index, this.createNodes(children));
      } else {
        element2.push(this.createNodes(children));
      }
    }
  }
  doDeleteChildren(element2, { after, index, length: length2 }) {
    let afterElement;
    if (after) {
      let i = 0;
      for (let e = element2.firstChild; e != null; e = e.nextSibling) {
      ...
      element2.delete(i, length2);
    } else {
      element2.delete(index, length2);
    }
  }
  doRemoveAttributes(element2, attributes) {
    for (let k of attributes) {
      element2.removeAttribute(k);
    }
  }
  doSetAttributes(element2, attributes) {
    for (let k of Object.keys(attributes)) {
      element2.setAttribute(k, attributes[k]);
    }
  }
  findNode(nodeID, root = this._y) {
    ...
    if (root instanceof YXmlElement) {
  ...
  doInsertText(element2, { index, text: text2, attributes }) {
    if (typeof text2 != "string") {
      throw new Error("Inserted text must be a string");
    }
    if (element2.nodeName != "text") {
      throw new Error("text can only be inserted in a text element");
    }
    const xmlText = element2.firstChild;
    xmlText.insert(index, text2, attributes);
  }
  doFormatText(element2, { from: from2, length: length2, attributes }) {
    if (element2.nodeName != "text") {
      throw new Error("text can only be inserted in a text element");
    }
    const xmlText = element2.firstChild;
    xmlText.format(from2, length2, attributes);
  }
  doDeleteText(element2, { index, length: length2 }) {
    if (element2.nodeName != "text") {
      throw new Error("text can only be inserted in a text element");
    }
    const xmlText = element2.firstChild;
    xmlText.delete(index, length2);
  }
  applyChanges(changes) {
    for (let change of changes) {
      const element2 = change.nodeID ? this.findNode(change.nodeID) : this._y;
      if (element2 == null) {
        throw new Error("Element was not found " + change.nodeID);
      }
      if (change.delete) {
        this.doDelete(element2);
      }
      if (change.insertChildren) {
        this.doInsertChildren(element2, change.insertChildren);
      }
      if (change.deleteChildren) {
        this.doDeleteChildren(element2, change.deleteChildren);
      }
      if (change.removeAttributes) {
        this.doRemoveAttributes(element2, change.removeAttributes);
      }
      if (change.setAttributes) {
        this.doSetAttributes(element2, change.setAttributes);
      }
      if (change.insertText) {
        this.doInsertText(element2, change.insertText);
      }
      if (change.formatText) {
        this.doFormatText(element2, change.formatText);
      }
      if (change.deleteText) {
        this.doDeleteText(element2, change.deleteText);
      }
    }
  }
};
...
var import_text_encoding = __toESM(require_main(), 1);
...
var encoder = new import_text_encoding.TextEncoder("utf-8");
var decoder = new import_text_encoding.TextDecoder("utf-8");

// entrypoint.js
var import_base_642 = __toESM(require_base64(), 1);
...
function applyChanges(update) {
  ...
  console.log(protocols.get(update.documentID).doc.get("xml", YXmlElement).toString());
}
function getState2(documentID, vector) {
  const server = documents.get(documentID);
  let state;
  if (vector) {
    state = encodeStateAsUpdate(server.doc, import_base_642.default.decode(String.fromCharCode(...state)));
  } else {
    state = encodeStateAsUpdate(server.doc);
  }
  return import_base_642.default.encode(String.fromCharCode(...state));
}
...
function applyBackendChanges(documentID, base64Changes) {
  ...
  const buffer = Uint8Array.from(import_base_642.default.decode(base64Changes), (c) => c.charCodeAt(0));
  console.log("applying", Array.from(buffer));
  server.applyBackendChanges(buffer);
  console.log(protocols.get(documentID).doc.get("xml", YXmlElement).toString());
}
function registerDocument(id2, base64Data, sendUpdateToBackend, sendUpdateToClient) {
  if (documents.get(id2)) {
  ...
  const clientProtocol = new ClientProtocol((update) => {
    ...
    (sendUpdateToBackend ?? onSendUpdateToBackend)(JSON.stringify({ "documentID": id2, "data": import_base_642.default.encode(str) }));
  });
  const server = new ServerXmlDocument(clientProtocol.doc, (update) => {
    (sendUpdateToClient ?? onSendUpdateToClient)(JSON.stringify({ "documentID": id2, "data": update }));
  });
  if (base64Data) {
    server.applyBackendChanges(Uint8Array.from(import_base_642.default.decode(base64Data), (c) => c.charCodeAt(0)));
  }
  documents.set(id2, server);
  protocols.set(id2, clientProtocol);
}
function unregisterDocument(id2) {
  if (!documents.get(id2)) {
    throw new Error("document was not registered " + id2);
  }
