...
// -----------------------------------------------------------------------------
void main() async {
  await DocumentRuntime.initialize();

  MeshDocument createNewDoc() {
    final doc =
        MeshDocument(schema: testSchema, sendChangesToBackend: (base64) {});
